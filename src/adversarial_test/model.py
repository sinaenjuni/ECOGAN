...
class Generator(nn.Module):
    def __init__(self, z_dim, g_shared_dim, img_size, g_conv_dim, num_classes, g_init):
        ...
        self.activation = g_act_fn
        self.conv2d5 = g_conv2d(in_channels=self.out_dims[-1], out_channels=3, kernel_size=3, stride=1, padding=1)
        self.tanh = nn.Tanh()
...
G = Generator(80, 128, 32, 96, 10, 'ortho')
...
class Discriminator(nn.Module):
    def __init__(self, img_size, d_conv_dim, apply_d_sn, d_cond_mtd, aux_cls_type, d_embed_dim, normalize_d_embed,
                 num_classes, d_init):
